...
<asp:Label ID="Label1" runat="server" ForeColor="Red" Text="Admin  Panel" Font-Bold="True" Font-Size="XX-Large" Font-Underline="True" ></asp:Label></div>
        ...
        <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:LinkButton ID="LinkButton5" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="X-Large" Font-Underline="False" ForeColor="#FF3300" OnClick="LinkButton5_Click">Logout</asp:LinkButton>
        </p>
        <p>
            &nbsp;</p>
    </form>
