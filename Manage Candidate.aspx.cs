...
namespace Project1
{
    public partial class Manage_Candidate : System.Web.UI.Page
    {
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            if (TextBox1.Text != "")
            {
                SqlCommand cmd = new SqlCommand("SELECT COUNT(1) from candidate WHERE Name='" + TextBox1.Text + "' ", con);
                ...
                {
                    Label3.Visible = true;
                    SqlCommand cmd1 = new SqlCommand("Delete From candidate where Name = '" + TextBox1.Text + "' ", con);
                    Label6.Text = "Deleted " + TextBox1.Text + " sucessfully";
                    int i = cmd1.ExecuteNonQuery();
                    Image1.Visible = false;

                    SqlCommand cmd2 = new SqlCommand("Select Name from candidate ", con);
